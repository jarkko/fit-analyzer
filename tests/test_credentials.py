...
class TestCreateEnvFile:
    ...
    def test_create_env_file_with_existing_gitignore_missing_env_add_yes(self, tmp_path, monkeypatch):
    ...
    def test_create_env_file_with_existing_gitignore_missing_env_add_no(self, tmp_path, monkeypatch):
